...
class UserProfile(Base):
    ...
    bank_verifications = relationship("KYCBankVerification", back_populates="user",foreign_keys="[KYCBankVerification.user_id]",cascade="all, delete-orphan", lazy="select",)
